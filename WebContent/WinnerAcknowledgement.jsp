...
%>
	...
	<h4>Thank You,<%= studentBean.getFirstName() %> <%= studentBean.getLastName() %> to for completing the survey</h4>
	<h4>Congratulations <%= studentBean.getFirstName() %>, you are the raffle winner of 2 movie tickets</h4>
